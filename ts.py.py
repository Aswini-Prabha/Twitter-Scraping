...
st.set_page_config(page_title="Twitter data scrapping webpage",page_icon=":sunglasses:",layout="wide")
st.title(" :large_blue_circle: Twitter scrapping :large_blue_circle:")
